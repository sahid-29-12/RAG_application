...
## 8. Sample document used for testing
...
## 9. Screenshots
*(As an assignment deliverable, please run the application, expand the Streamlit accordion menus, take screenshots of the following steps, and place them in a `screenshots/` folder):*
* 10. Document ingestion
* 11. Embedding/indexing process (Showing the Chunks)
* 12. Vector database/search
* 13. User query
* 14. Retrieved context (Showing similarity scores)
...
### 18. Why a vector database is required
...
### 19. How similarity search works
...
### 20. What chunk size and overlap you selected
...
### 21. How RAG differs from simply asking an LLM a question
